...
//hasan convert number
function numberFarsiToEnlish($string)
{
...
$postVerifyCode = numberFarsiToEnlish($_POST['input_contact_vfcd']);
...
if (isset($_SESSION['chap_mobile']) && $_SESSION['chap_mobile_date']+$waitTime>time())
{
	...
	else if ($postVerifyCode == $_SESSION['chap_mobile_vfcd'])
	{
		$params = array(
