...
<head>
    ...
    <meta name="description"
          content="محاسبه آنلاین هزینه چاپ کتاب و کتاب شعر | محاسبه آنلاین چاپ دیجیتال کتاب | اولین و کاملترین سیستم خودکار محاسبه آنلاین چاپ کتاب | 724 چاپ"/>
    ...
    <meta prefix="og: http://ogp.me/ns#" property="og:description"
          content="محاسبه آنلاین هزینه چاپ کتاب و کتاب شعر | محاسبه آنلاین چاپ دیجیتال کتاب | اولین سیستم خودکار محاسبه آنلاین چاپ کتاب | 724 چاپ"/>
	...
	*/ ?>
    ...
    <script type="text/javascript">
        !function () {
            ...
            function g() {
                var g = d.createElement("script"), s = "https://www.goftino.com/widget/asFtZU",
    ...
    <script> !function (t, e, n) {
            ...
            s.id = "ua-script-7ZFtAnY6";
            s.dataset.analyticsobject = n;
            s.async = 1;
            s.type = "text/javascript";
            s.src = "https://cdn.yektanet.com/rg_woebegone/scripts_v3/7ZFtAnY6/rg.complete.js?v=" + r, c.parentNode.insertBefore(s, c)
...
<footer id="footer">
    ...
    <div class="copyright-wrap">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <p class="copyright-text text-center">© تمامی حقوق برای <a href="https://724chap.com">724 چاپ</a>
                        محفوظ است</p>
                </div>
            </div>
        </div>
...
<div id="msgbox" style="position: fixed; height: 100%; width: 100%; top:0; left:0; display: none; z-index: 1030">
    <div style="position: absolute; width: 100%; height: 100%; left:0; top:0; background-color: black; opacity: 0.6"
         onclick="$('#msgbox').hide();"></div>
        ...
        <table style="height: 120px; width: 100%;" cellpadding="0" cellspacing="0">
            <tr>
                <td valign="top" style="background-color: #F5F5F5; padding: 5px;">
                    <p style="line-height: normal; direction: rtl; font-family: iransans; font-size: 12px; text-align: right; color: black"
                       id="msgboxnote"></p>
                </td>
            </tr>
            <tr style="height: 25px;">
                <td valign="bottom">
                    <p dir="ltr" align="left"
                       style="line-height: normal; text-align: left; font-family: iransans; font-size: 12px;"
                       id="msgboxtick"><a style="color: black" onkeyup="if (event.keyCode == 27) $('#msgbox').hide();"
                                          id="msgboxbutton" href="javascript:void(0);" onclick="$('#msgbox').hide();">بستن</a>
                    </p>
                </td>
            </tr>
        </table>
...
<style>
    ...
    .watsap-alo-ph-img-circle {
        width: 30px;
        height: 30px;
        top: 45px;
        right: 45px;
        position: absolute;
        background: url("img/watsapp.png") center center no-repeat rgba(30, 30, 30, .1);
    ...
    .animatedd.bounceIn, .animatedd.bounceOut, .animatedd.flipOutX, .animatedd.flipOutY {
...
<a href="tel:02166501818" class="call-now">
    ...
    <div class="mypage-alo-phone">
        <a href="tel:02166501818" class=""
           style="background: #30a3cd; padding: 10px 10px 4px 10px; font-size: 19px; color: #fff; border-radius: 41px;">021-66501818</a>
