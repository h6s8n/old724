...
add_action( 'widgets_init', 'register_xecuter_list_1c' );
 function register_xecuter_list_1c() {
    register_widget( 'xecuter_list_1c' );
}

class xecuter_list_1c extends WP_Widget {
 	function __construct() {
		parent::__construct(
			'xecuter_list_1c',
			 'Xecuter - '. esc_html__('Posts Box List 1 Column', 'xecuter') 
		);
	}
    ...
    /**********  The widget For Display *******/
 	public function widget( $args, $instance ) {
		...
		?>
		<div id="<?php echo esc_attr($widget_id) ?>" class="rd-widget-list rd-list rd-module-item  rd-space  rd-widget-post  rd-widget widget <?php echo esc_attr($ratio);?>">
        ...
        <?php } ?>
				...
				while ( $query->have_posts() ) : $query->the_post(); 
					echo'<div class="rd-post-item  rd-col-1-1">';
						xecuter_post_widget_1( $instance,$post_size.' '.$post_ratio.' rd-post-1-3  rd-col-1-1 '.$size ,$image,$excerpt,$meta_category);
					echo'</div>';
