...
add_action( 'widgets_init', 'register_xecuter_featured_1c' );
 function register_xecuter_featured_1c() {
    register_widget( 'xecuter_featured_1c' );
}

class xecuter_featured_1c extends WP_Widget {
 	function __construct() {
		parent::__construct(
			'xecuter_featured_1c',
			 'Xecuter - '. esc_html__('Posts Box Featured 1 Column', 'xecuter') 
		);
	}
	...
	/********** Display the widget update form *******/
 	public function form( $instance ) { 
        ...
        <p>
			...
			<input id="<?php echo esc_attr($this->get_field_id( 'excerpt') ); ?>" name="<?php echo esc_html($this->get_field_name( 'excerpt' )); ?>" <?php checked( $excerpt ); ?> type="checkbox" />
 		</p>    
 		<p>
