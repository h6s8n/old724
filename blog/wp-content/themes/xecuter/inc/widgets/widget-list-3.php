...
add_action( 'widgets_init', 'register_xecuter_list_3' );
 function register_xecuter_list_3() {
    register_widget( 'xecuter_list_3' );
}

class xecuter_list_3 extends WP_Widget {
 	function __construct() {
		parent::__construct(
			'xecuter_list_3',
			 'Xecuter - '. esc_html__('Posts Box List 3', 'xecuter') 
		);
	}
