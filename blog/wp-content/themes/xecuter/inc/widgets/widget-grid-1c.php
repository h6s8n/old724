...
add_action( 'widgets_init', 'register_xecuter_grid_1c' );
 function register_xecuter_grid_1c() {
    register_widget( 'xecuter_grid_1c' );
}

class xecuter_grid_1c extends WP_Widget {
 	function __construct() {
		parent::__construct(
			'xecuter_grid_1c',
			 'Xecuter - '. esc_html__('Posts Box Grid 1 Column', 'xecuter') 
		);
	}
    ...
    /**********  The widget For Display *******/
 	public function widget( $args, $instance ) {
		...
		?>
		<div id="<?php echo esc_attr($widget_id) ?>" class="rd-widget-grid rd-grid rd-module-item  rd-widget-post  rd-widget widget <?php echo esc_attr($ratio);?>">
        ...
        <?php } ?>
				...
				while ( $query->have_posts() ) : $query->the_post(); 
					echo'<div class="rd-post-item  rd-col-1-1">';
						xecuter_post_widget_2($instance,'rd-post-1-3 rd-col-1-1  rd-979-3c  rd-767-1c rd-499-1c ',$image);
					echo'</div>';
				endwhile; 
				endif; 
				wp_reset_postdata();
