...
add_action( 'widgets_init', 'register_xecuter_text_2' );
 function register_xecuter_text_2() {
    register_widget( 'xecuter_text_2' );
}

class xecuter_text_2 extends WP_Widget {
 	function __construct() {
		parent::__construct(
			'xecuter_text_2',
			 'Xecuter - '. esc_html__('Posts Box Text 2', 'xecuter') 
		);
	}
 	...
 	public function widget( $args, $instance ) {
        ...
        <?php } ?>
				...
				while ( $query->have_posts() ) : $query->the_post(); $count++;
					...
					if($count==1 ){
						echo'<div class="rd-grid  rd-post-item rd-col-1-1 '.esc_attr($ratio).'">';
