...
if(!empty($meta['xecuter_page_builder']) && intval(get_query_var('paged') <= 1 ) ){
			
	$xecuter_rows = get_post_meta( $meta['xecuter_page_builder'][0], 'xecuter_row', true);
	$xecuter_wide = get_post_meta( $meta['xecuter_page_builder'][0], 'xecuter_wide', true);
	$xecuter_content = get_post_meta( $meta['xecuter_page_builder'][0], 'xecuter_content', true);
	$xecuter_main = get_post_meta( $meta['xecuter_page_builder'][0], 'xecuter_main', true);
	$xecuter_mini = get_post_meta( $meta['xecuter_page_builder'][0], 'xecuter_mini', true);
    	...
    	<div class="rd-row-container">         
            ...
            <div class="rd-column <?php echo esc_attr(xecuter_col(true));?>">
                ...
                <div id="rd_module_blog" class="rd-module-item rd-space">
                    ...
                    <div class="rd-title-box"><h4><span class="rd-active"><?php echo esc_html( the_archive_title());?></span></h4></div> 
